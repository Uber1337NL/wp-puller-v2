...
class WP_Puller_Admin
{
    ...
    public function ajax_save_settings()
    {
        ...
        $theme_path_secondary = isset($_POST['theme_path_secondary']) ? sanitize_text_field(wp_unslash($_POST['theme_path_secondary'])) : '';
        ...
        update_option('wp_puller_theme_path_secondary', $theme_path_secondary);

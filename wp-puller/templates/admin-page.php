        ...
        <div class="wp-puller-card wp-puller-card-settings">
            ...
            <div class="wp-puller-card-body">
                <form id="wp-puller-settings-form">
                    ...
                    <div class="wp-puller-field">
                        <label for="wp-puller-theme-path-secondary"><?php esc_html_e('Second Theme Path', 'wp-puller'); ?></label>
                        <input type="text"
                            id="wp-puller-theme-path-secondary"
                            name="theme_path_secondary"
                            value="<?php echo esc_attr(isset($status['theme_path_secondary']) ? $status['theme_path_secondary'] : ''); ?>"
                            placeholder="<?php esc_attr_e('Optional: parent/base theme path', 'wp-puller'); ?>"
                            class="regular-text">
                        <p class="description"><?php esc_html_e('Optional second subdirectory to deploy in the same update. Useful for child + parent/base theme repositories.', 'wp-puller'); ?></p>
                    </div>
